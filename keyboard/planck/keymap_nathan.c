...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP_GRID(
    ...
    * |-----------------------------------------------------------------------|
    * |     |C/A/D|C/S/E| Ins |Print|Pause|SLock|Num. |Num4 |Num5 |Num6 |Num= |
    * |-----------------------------------------------------------------------|
    * |     | P0  | P1  | P2  | P3  | P4  | P5  |Num0 |Num1 |Num2 |Num3 |Num/ |
    * |-----------------------------------------------------------------------|
    * |     |     |     |     |     |     |     |     |Home |PgDn |PgUp | End |
    * `-----------------------------------------------------------------------'
    */
  [1] = KEYMAP_GRID(
       ...
       TRNS, FN16, FN17, INS,  PSCR, PAUS, SLCK, PDOT, P4,   P5,   P6,   PEQL,
       TRNS, FN2,  FN3,  FN4,  FN5,  FN6,  FN7, P0,   P1,   P2,   P3,   PSLS,
  ...
  /* 2: fn right/raise layer
    ...
    * |     | _   | '   | "   | `   | ~   |     |     | ]   | )   | }   | >   |
    * |-----------------------------------------------------------------------|
    * |     |NextT|PrevT|     |     |     |     |     |Mute |Vol- |Vol+ | P/P |
    * `-----------------------------------------------------------------------'
    */
  [2] = KEYMAP_GRID(
       F1,   F2,   F3,   F4,   F5,   F6,   F7,   F8,   F9,   F10,  F11,  F12,
       TRNS, FN18, FN19, FN20, FN21, FN22, FN23, FN24, FN25, MINS, FN26,   PAST,
       TRNS, FN27, QUOT, FN28, GRV,  FN29, TRNS, TRNS, RBRC, FN13, FN14, FN15,
