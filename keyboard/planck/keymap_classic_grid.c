...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  /* 0: main layer */
  KEYMAP_GRID( ESC,  Q,    W,    E,    R,   T,   Y,   U,   I,    O,    P,    TAB,  \
               LCTL, A,    S,    D,    F,   G,   H,   J,   K,    L,    SCLN, BSPC, \
               LALT, Z,    X,    C,    V,   B,   N,   M,   COMM, DOT,  SLSH, ENT,  \
               RSFT, LCTL, LGUI, LSFT, FN0, SPC, SPC, FN1, LEFT, DOWN, UP,   RGHT),
  /*1: fn lower layer */
  KEYMAP_GRID( POWER, PSCR, SLCK, PAUS, NLCK,  EXECUTE, MENU, APP,   P7, P8,   P9,   PSLS, \
               TRNS,  VOLD, VOLU, MUTE, CAPS,  CANCEL,  UNDO, AGAIN, P4, P5,   P6,   PAST, \
               TRNS,  INS,  CUT,  COPY, PASTE, FN14,    FN15, FN16,  P1, P2,   P3,   PMNS, \
               TRNS,  TRNS, TRNS, TRNS, TRNS,  TRNS,    TRNS, TRNS,  P0, PDOT, PENT, PPLS ),
  
  /* 2: fn raise layer */
  KEYMAP_GRID( F1,   F2,   F3,   F4,   F5,   F6,   F7,   F8,   F9,   F10,  F11,    F12,   \
